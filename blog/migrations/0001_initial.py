	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('original_description', rich_editor.fields.RichTextOriginalField(max_length=1000, verbose_name='popis blogu', property_name='description', filtered_field='filtered_description', blank=True)),
