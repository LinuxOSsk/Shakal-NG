...
SPRITES = (
	{
		...
		'images': (
			...
			{ 'name': 'header_bg', 'src': 'new/images/header_bg.png', 'mode': 'repeat-x' },
			{ 'name': 'bottom_shadow', 'src': 'new/images/bottom_shadow.png', 'mode': 'repeat-x' },
		),
	},
	{
		'name': 'sprites',
		...
		'images': (
			...
			{ 'name': 'btn_std', 'src': 'default/images/btn.png' },
			{ 'name': 'btn_std_hover', 'src': 'default/images/btn.png' },
			{ 'name': 'btn_act', 'src': 'default/images/btn.png' },
			{ 'name': 'btn_act_hover', 'src': 'default/images/btn.png' },
			{ 'name': 'btn_content_std', 'src': 'default/images/btn_content.png' },
			{ 'name': 'btn_content_std_hover', 'src': 'default/images/btn_content.png' },
			{ 'name': 'btn_content_act', 'src': 'default/images/btn_content.png' },
			{ 'name': 'btn_content_act_hover', 'src': 'default/images/btn_content.png' },
			...
			{ 'name': 'tabs_std', 'src': 'default/images/tabs.png' },
			{ 'name': 'tabs_act', 'src': 'default/images/tabs.png' },
