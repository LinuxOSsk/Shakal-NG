	...
	def import_news(self):
		...
		for news_row in self.cursor:
			...
			news = {
				...
				'slug': slug,
				'original_short_text': 'html:' + news_dict['sprava'],
				'filtered_short_text': news_dict['sprava'],
				'original_long_text': u'html:' + news_dict['sprava'],
				'filtered_long_text': news_dict['sprava'],
	...
	def import_discussion_headers(self):
		...
		for header_row in self.cursor:
			...
			header = {
				...
				'last_comment': header_dict['time'] if header_dict['last_time'] is None else header_dict['last_time'],
		...
		for id, content_type_id, object_id, is_locked, pub_date in headers:
			...
			for comment_dict in comment_rows:
				...
				comment = {
					...
					'original_comment': u'html:' + comment_dict['text'],
					'filtered_comment': comment_dict['text'],
