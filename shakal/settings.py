...
DEFAULT_JINJA2_TEMPLATE_INTERCEPT_RE = r"^(.*/home.html|article/.*.html|blog/.*.html|feeds/.*.html|forum/.*.html|messages/.*.html|news/.*.html|notifications/.*.html|polls/.*.html|registration/.*(.html|.txt)|search/.*(.html|.txt)|template_dynamicloader/.*(.html)|widgets/.*(.html)|.*jinja.htm)"
