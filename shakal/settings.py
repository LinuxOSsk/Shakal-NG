...
STATICFILES_DIRS = (
	...
	('templates', os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'templates'), 'static'))),
)
...
SECRET_KEY = 'w@$j#cu+l!+^i6(1y6y()j0jqxwcc__04mp%k6(8)xrpi1^=52'
...
MIDDLEWARE_CLASSES = (
	...
	'shakal.template_dynamicloader.middleware.RequestMiddleware',
	'shakal.paginator.middleware.PaginatorMiddleware',
