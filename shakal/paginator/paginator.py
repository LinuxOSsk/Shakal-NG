...
from shakal.paginator.settings import PAGINATOR_INSIDE_COUNT, PAGINATOR_OUTSIDE_COUNT, PAGINATOR_RAISES_404

class Paginator:
	def __init__(self, current_page, page_count, url = None, urlparams = {}, inside = PAGINATOR_INSIDE_COUNT, outside = PAGINATOR_OUTSIDE_COUNT, raises_404 = PAGINATOR_RAISES_404):
		self.pages = []
