	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('author', models.ForeignKey(related_name='my_desktops', verbose_name='autor', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
			],
			options={
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('created', models.DateTimeField(verbose_name='vytvoren\xe9', editable=False)),
				('updated', models.DateTimeField(verbose_name='upraven\xe9', editable=False)),
				('desktop', models.ForeignKey(verbose_name='desktop', to='desktops.Desktop', on_delete=models.CASCADE)),
				('user', models.ForeignKey(verbose_name='pou\u017e\xedvate\u013e', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
			],
		),
		migrations.AddField(
			model_name='desktop',
